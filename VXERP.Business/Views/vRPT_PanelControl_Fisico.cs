...
{
    public class vRPT_PanelControl_Fisico : BaseViews.BaseViewString
    {

        private const string SP_NAME = "rpt_PanelControl_Fisico";

        public vRPT_PanelControl_Fisico(params System.Data.SqlClient.SqlParameter[] SP_PARAMS)
