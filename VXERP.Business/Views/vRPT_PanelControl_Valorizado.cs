...
{
    public class vRPT_PanelControl_Valorizado : BaseViews.BaseViewString
    {

        private const string SP_NAME = "rpt_PanelControl_Valorizado";

        public vRPT_PanelControl_Valorizado(params System.Data.SqlClient.SqlParameter[] SP_PARAMS)
