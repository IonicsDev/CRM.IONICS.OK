...
{
    public class vStockValorizadoSinTratar : BaseViews.BaseViewString
    {

        private const string SP_NAME = "StockValorizadoSinTratar";

        public vStockValorizadoSinTratar(params System.Data.SqlClient.SqlParameter[] SP_PARAMS)
