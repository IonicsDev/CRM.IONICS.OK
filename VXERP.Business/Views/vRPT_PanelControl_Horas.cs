...
{
    public class vRPT_PanelControl_Horas : BaseViews.BaseViewString
    {

        private const string SP_NAME = "rpt_PanelControl_Horas";

        public vRPT_PanelControl_Horas(params System.Data.SqlClient.SqlParameter[] SP_PARAMS)
