...
{
    public class PersonasEnEsperaController : BaseController
    {
        ArchivoModuloRepository archivoRepository = new ArchivoModuloRepository();

        public vPersonasEnEspera vPersonasEnEspera = new vPersonasEnEspera();

        public ActionResult Index()
        {
            ClearTempFolder();
            return View(vPersonasEnEspera);
        }

        public ActionResult GridPersonasEnEspera()
        {
            return PartialView("_GridForViews", vPersonasEnEspera);
        }


        public ActionResult View(int id)
        {
            DataTable datos = vPersonasEnEspera.GetByID(id);
            vPersonasEnEspera.Datos = datos;
            vPersonasEnEspera.Id = id;
            ...
            return View("FormViewFichaPersonalEnEspera", vPersonasEnEspera);
        }
