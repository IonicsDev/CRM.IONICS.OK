...
{
    public class PersonasEnPlantaController : BaseController
    {
        ArchivoModuloRepository archivoRepository = new ArchivoModuloRepository();

       public vPersonasEnPlanta vPersonasEnPlanta = new vPersonasEnPlanta();

        public ActionResult Index()
        {
            ClearTempFolder();
            return View(vPersonasEnPlanta);
        }

        public ActionResult GridPersonasEnPlanta()
        {
            return PartialView("_GridForViews", vPersonasEnPlanta);
        }


        public ActionResult View(int id)
        {
            DataTable datos = vPersonasEnPlanta.GetByID(id);
            vPersonasEnPlanta.Datos = datos;
            vPersonasEnPlanta.Id = id;
            ...
            return View("FormViewFichaPersonalEnPlanta", vPersonasEnPlanta);
        }
